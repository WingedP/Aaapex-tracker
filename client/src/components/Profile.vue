...
<section>
    <div v-if="loading">
        <img src="https://thumbs.gfycat.com/ConventionalOblongFairybluebird-small.gif" alt="" class="loader">
    </div>
...
<ul>
    ...
    <li><h4>Selected Legend</h4>
    <p>{{profileData.metadata.activeLegendName}}</p></li>


<li v-if="profileData.segments[0].stats.season5Wins">
            <h4>Season 5 Win</h4>
    <p>{{profileData.segments[0].stats.season5Wins.displayValue}}
...
export default {
    ...
    `/api/v1/profile/${this.$route.params.platform}/${this.$route.params.gamertag}`);
        ...
        console.log("your profile data", this.profileData);
        console.log("stuff",this.profileData.segments[1].metadata.imageUrl)
